...
namespace MavLink
{
    ...
    public static class MavLinkSerializer
    {
        ...
        public static Dictionary<int, MavPacketInfo> Lookup = new Dictionary<int, MavPacketInfo>
        {
            ...
            {8, new MavPacketInfo(Deserialize_LINK_NODE_STATUS, 117)},
            ...
            {52, new MavPacketInfo(Deserialize_MISSION_CHANGED, 132)},
            ...
            {269, new MavPacketInfo(Deserialize_VIDEO_STREAM_INFORMATION, 109)},
            {270, new MavPacketInfo(Deserialize_VIDEO_STREAM_STATUS, 59)},
            {280, new MavPacketInfo(Deserialize_GIMBAL_MANAGER_INFORMATION, 128)},
            {281, new MavPacketInfo(Deserialize_GIMBAL_MANAGER_STATUS, 252)},
            {282, new MavPacketInfo(Deserialize_GIMBAL_MANAGER_SET_ATTITUDE, 252)},
            {283, new MavPacketInfo(Deserialize_GIMBAL_DEVICE_INFORMATION, 247)},
            {284, new MavPacketInfo(Deserialize_GIMBAL_DEVICE_SET_ATTITUDE, 99)},
            {285, new MavPacketInfo(Deserialize_GIMBAL_DEVICE_ATTITUDE_STATUS, 82)},
            {286, new MavPacketInfo(Deserialize_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE, 62)},
            {299, new MavPacketInfo(Deserialize_WIFI_CONFIG_AP, 19)},
            {300, new MavPacketInfo(Deserialize_PROTOCOL_VERSION, 217)},
            {301, new MavPacketInfo(Deserialize_AIS_VESSEL, 243)},
            ...
            {330, new MavPacketInfo(Deserialize_OBSTACLE_DISTANCE, 23)},
            {331, new MavPacketInfo(Deserialize_ODOMETRY, 91)},
            {332, new MavPacketInfo(Deserialize_TRAJECTORY_REPRESENTATION_WAYPOINTS, 236)},
            {333, new MavPacketInfo(Deserialize_TRAJECTORY_REPRESENTATION_BEZIER, 231)},
            {334, new MavPacketInfo(Deserialize_CELLULAR_STATUS, 135)},
            {335, new MavPacketInfo(Deserialize_ISBD_LINK_STATUS, 225)},
            {340, new MavPacketInfo(Deserialize_UTM_GLOBAL_POSITION, 99)},
            {350, new MavPacketInfo(Deserialize_DEBUG_FLOAT_ARRAY, 232)},
            {360, new MavPacketInfo(Deserialize_ORBIT_EXECUTION_STATUS, 11)},
            {370, new MavPacketInfo(Deserialize_SMART_BATTERY_INFO, 98)},
            {371, new MavPacketInfo(Deserialize_SMART_BATTERY_STATUS, 161)},
            {375, new MavPacketInfo(Deserialize_ACTUATOR_OUTPUT_STATUS, 251)},
            {380, new MavPacketInfo(Deserialize_TIME_ESTIMATE_TO_TARGET, 232)},
            {385, new MavPacketInfo(Deserialize_TUNNEL, 147)},
            {390, new MavPacketInfo(Deserialize_ONBOARD_COMPUTER_STATUS, 156)},
            {395, new MavPacketInfo(Deserialize_COMPONENT_INFORMATION, 231)},
            {400, new MavPacketInfo(Deserialize_PLAY_TUNE_V2, 110)},
            {401, new MavPacketInfo(Deserialize_SUPPORTED_TUNES, 183)},
            {9000, new MavPacketInfo(Deserialize_WHEEL_DISTANCE, 113)},
            {12900, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_BASIC_ID, 197)},
            {12901, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_LOCATION, 16)},
            {12902, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_AUTHENTICATION, 181)},
            {12903, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_SELF_ID, 149)},
            {12904, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_SYSTEM, 238)},
            {12905, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_OPERATOR_ID, 56)},
            {12915, new MavPacketInfo(Deserialize_OPEN_DRONE_ID_MESSAGE_PACK, 67)},
        };
        ...
        internal static MavlinkMessage Deserialize_LINK_NODE_STATUS(byte[] bytes, int offset)
        {
            return new Msg_link_node_status
            {
                timestamp = bitconverter.ToUInt64(bytes, offset + 0),
                tx_rate = bitconverter.ToUInt32(bytes, offset + 8),
                rx_rate = bitconverter.ToUInt32(bytes, offset + 12),
                messages_sent = bitconverter.ToUInt32(bytes, offset + 16),
                messages_received = bitconverter.ToUInt32(bytes, offset + 20),
                messages_lost = bitconverter.ToUInt32(bytes, offset + 24),
                rx_parse_err = bitconverter.ToUInt16(bytes, offset + 28),
                tx_overflows = bitconverter.ToUInt16(bytes, offset + 30),
                rx_overflows = bitconverter.ToUInt16(bytes, offset + 32),
                tx_buf = bytes[offset + 34],
                rx_buf = bytes[offset + 35],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_GPS_RAW_INT(byte[] bytes, int offset)
        {
            return new Msg_gps_raw_int
            {
                ...
                yaw = bitconverter.ToUInt16(bytes, offset + 50),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_SCALED_IMU(byte[] bytes, int offset)
        {
            return new Msg_scaled_imu
            {
                ...
                temperature = bitconverter.ToInt16(bytes, offset + 22),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_RAW_IMU(byte[] bytes, int offset)
        {
            return new Msg_raw_imu
            {
                ...
                id = bytes[offset + 26],
                temperature = bitconverter.ToInt16(bytes, offset + 27),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_ATTITUDE_QUATERNION(byte[] bytes, int offset)
        {
            return new Msg_attitude_quaternion
            {
                ...
                repr_offset_q = ByteArrayUtil.ToSingle(bytes, offset + 32, 4),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_MISSION_CHANGED(byte[] bytes, int offset)
        {
            return new Msg_mission_changed
            {
                start_index = bitconverter.ToInt16(bytes, offset + 0),
                end_index = bitconverter.ToInt16(bytes, offset + 2),
                origin_sysid = bytes[offset + 4],
                origin_compid = bytes[offset + 5],
                mission_type = bytes[offset + 6],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_RC_CHANNELS_OVERRIDE(byte[] bytes, int offset)
        {
            return new Msg_rc_channels_override
            {
                ...
                chan9_raw = bitconverter.ToUInt16(bytes, offset + 18),
                chan10_raw = bitconverter.ToUInt16(bytes, offset + 20),
                chan11_raw = bitconverter.ToUInt16(bytes, offset + 22),
                chan12_raw = bitconverter.ToUInt16(bytes, offset + 24),
                chan13_raw = bitconverter.ToUInt16(bytes, offset + 26),
                chan14_raw = bitconverter.ToUInt16(bytes, offset + 28),
                chan15_raw = bitconverter.ToUInt16(bytes, offset + 30),
                chan16_raw = bitconverter.ToUInt16(bytes, offset + 32),
                chan17_raw = bitconverter.ToUInt16(bytes, offset + 34),
                chan18_raw = bitconverter.ToUInt16(bytes, offset + 36),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_COMMAND_ACK(byte[] bytes, int offset)
        {
            return new Msg_command_ack
            {
                ...
                result_param2 = bitconverter.ToInt32(bytes, offset + 4),
        ...
        internal static MavlinkMessage Deserialize_GLOBAL_VISION_POSITION_ESTIMATE(byte[] bytes, int offset)
        {
            return new Msg_global_vision_position_estimate
            {
                ...
                covariance = ByteArrayUtil.ToSingle(bytes, offset + 32, 21),
                reset_counter = bytes[offset + 116],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_GPS2_RAW(byte[] bytes, int offset)
        {
            return new Msg_gps2_raw
            {
                ...
                yaw = bitconverter.ToUInt16(bytes, offset + 35),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_DISTANCE_SENSOR(byte[] bytes, int offset)
        {
            return new Msg_distance_sensor
            {
                ...
                horizontal_fov = bitconverter.ToSingle(bytes, offset + 14),
                vertical_fov = bitconverter.ToSingle(bytes, offset + 18),
                quaternion = ByteArrayUtil.ToSingle(bytes, offset + 22, 4),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_ATT_POS_MOCAP(byte[] bytes, int offset)
        {
            return new Msg_att_pos_mocap
            {
                ...
                covariance = ByteArrayUtil.ToSingle(bytes, offset + 36, 21),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_BATTERY_STATUS(byte[] bytes, int offset)
        {
            return new Msg_battery_status
            {
                ...
                time_remaining = bitconverter.ToInt32(bytes, offset + 36),
                charge_state = bytes[offset + 40],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_AUTOPILOT_VERSION(byte[] bytes, int offset)
        {
            return new Msg_autopilot_version
            {
                ...
                uid2 = ByteArrayUtil.ToUInt8(bytes, offset + 60, 18),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_FENCE_STATUS(byte[] bytes, int offset)
        {
            return new Msg_fence_status
            {
                ...
                breach_mitigation = bytes[offset + 8],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_GPS_INPUT(byte[] bytes, int offset)
        {
            return new Msg_gps_input
            {
                ...
                yaw = bitconverter.ToUInt16(bytes, offset + 63),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_STATUSTEXT(byte[] bytes, int offset)
        {
            return new Msg_statustext
            {
                ...
                id = bitconverter.ToUInt16(bytes, offset + 51),
                chunk_seq = bytes[offset + 53],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_PLAY_TUNE(byte[] bytes, int offset)
        {
            return new Msg_play_tune
            {
                ...
                tune2 = ByteArrayUtil.ToChar(bytes, offset + 32, 200),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_CAMERA_SETTINGS(byte[] bytes, int offset)
        {
            return new Msg_camera_settings
            {
                ...
                zoomLevel = bitconverter.ToSingle(bytes, offset + 5),
                focusLevel = bitconverter.ToSingle(bytes, offset + 9),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_MOUNT_ORIENTATION(byte[] bytes, int offset)
        {
            return new Msg_mount_orientation
            {
                ...
                pitch = bitconverter.ToSingle(bytes, offset + 8),
                yaw = bitconverter.ToSingle(bytes, offset + 12),
                yaw_absolute = bitconverter.ToSingle(bytes, offset + 16),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_VIDEO_STREAM_INFORMATION(byte[] bytes, int offset)
        {
            return new Msg_video_stream_information
            {
                ...
                resolution_h = bitconverter.ToUInt16(bytes, offset + 10),
                resolution_v = bitconverter.ToUInt16(bytes, offset + 12),
                rotation = bitconverter.ToUInt16(bytes, offset + 14),
                hfov = bitconverter.ToUInt16(bytes, offset + 16),
                stream_id = bytes[offset + 18],
                count = bytes[offset + 19],
                type = bytes[offset + 20],
                name = ByteArrayUtil.ToChar(bytes, offset + 21, 32),
                uri = ByteArrayUtil.ToChar(bytes, offset + 53, 160),
            };
        }

        internal static MavlinkMessage Deserialize_VIDEO_STREAM_STATUS(byte[] bytes, int offset)
        {
            return new Msg_video_stream_status
            {
                framerate = bitconverter.ToSingle(bytes, offset + 0),
                bitrate = bitconverter.ToUInt32(bytes, offset + 4),
                flags = bitconverter.ToUInt16(bytes, offset + 8),
        ...
        internal static MavlinkMessage Deserialize_GIMBAL_MANAGER_INFORMATION(byte[] bytes, int offset)
        {
            return new Msg_gimbal_manager_information
            {
                time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
                cap_flags = bitconverter.ToUInt32(bytes, offset + 4),
                tilt_max = bitconverter.ToSingle(bytes, offset + 8),
                tilt_min = bitconverter.ToSingle(bytes, offset + 12),
                tilt_rate_max = bitconverter.ToSingle(bytes, offset + 16),
                pan_max = bitconverter.ToSingle(bytes, offset + 20),
                pan_min = bitconverter.ToSingle(bytes, offset + 24),
                pan_rate_max = bitconverter.ToSingle(bytes, offset + 28),
                gimbal_component = bytes[offset + 32],
            };
        }

        internal static MavlinkMessage Deserialize_GIMBAL_MANAGER_STATUS(byte[] bytes, int offset)
        {
            return new Msg_gimbal_manager_status
            {
                time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
        ...
        internal static MavlinkMessage Deserialize_GIMBAL_MANAGER_SET_ATTITUDE(byte[] bytes, int offset)
        {
            return new Msg_gimbal_manager_set_attitude
            {
                flags = bitconverter.ToUInt32(bytes, offset + 0),
                q = ByteArrayUtil.ToSingle(bytes, offset + 4, 4),
                angular_velocity_x = bitconverter.ToSingle(bytes, offset + 20),
                angular_velocity_y = bitconverter.ToSingle(bytes, offset + 24),
                angular_velocity_z = bitconverter.ToSingle(bytes, offset + 28),
                target_system = bytes[offset + 32],
                target_component = bytes[offset + 33],
            };
        }

        internal static MavlinkMessage Deserialize_GIMBAL_DEVICE_INFORMATION(byte[] bytes, int offset)
        {
            return new Msg_gimbal_device_information
            {
                time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
                firmware_version = bitconverter.ToUInt32(bytes, offset + 4),
                tilt_max = bitconverter.ToSingle(bytes, offset + 8),
                ...
                pan_min = bitconverter.ToSingle(bytes, offset + 24),
                pan_rate_max = bitconverter.ToSingle(bytes, offset + 28),
                cap_flags = bitconverter.ToUInt16(bytes, offset + 32),
                vendor_name = ByteArrayUtil.ToUInt8(bytes, offset + 34, 32),
                model_name = ByteArrayUtil.ToUInt8(bytes, offset + 66, 32),
            };
        }

        internal static MavlinkMessage Deserialize_GIMBAL_DEVICE_SET_ATTITUDE(byte[] bytes, int offset)
        {
            return new Msg_gimbal_device_set_attitude
            {
                q = ByteArrayUtil.ToSingle(bytes, offset + 0, 4),
                angular_velocity_x = bitconverter.ToSingle(bytes, offset + 16),
                angular_velocity_y = bitconverter.ToSingle(bytes, offset + 20),
                angular_velocity_z = bitconverter.ToSingle(bytes, offset + 24),
                flags = bitconverter.ToUInt16(bytes, offset + 28),
                target_system = bytes[offset + 30],
                target_component = bytes[offset + 31],
            };
        }

        internal static MavlinkMessage Deserialize_GIMBAL_DEVICE_ATTITUDE_STATUS(byte[] bytes, int offset)
        {
            return new Msg_gimbal_device_attitude_status
            {
                time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
                q = ByteArrayUtil.ToSingle(bytes, offset + 4, 4),
                angular_velocity_x = bitconverter.ToSingle(bytes, offset + 20),
                angular_velocity_y = bitconverter.ToSingle(bytes, offset + 24),
                angular_velocity_z = bitconverter.ToSingle(bytes, offset + 28),
                failure_flags = bitconverter.ToUInt32(bytes, offset + 32),
                flags = bitconverter.ToUInt16(bytes, offset + 36),
            };
        }

        internal static MavlinkMessage Deserialize_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE(byte[] bytes, int offset)
        {
            return new Msg_autopilot_state_for_gimbal_device
            {
                time_boot_us = bitconverter.ToUInt64(bytes, offset + 0),
                q = ByteArrayUtil.ToSingle(bytes, offset + 8, 4),
                q_estimated_delay_us = bitconverter.ToUInt32(bytes, offset + 24),
                vx = bitconverter.ToSingle(bytes, offset + 28),
                vy = bitconverter.ToSingle(bytes, offset + 32),
                vz = bitconverter.ToSingle(bytes, offset + 36),
                v_estimated_delay_us = bitconverter.ToUInt32(bytes, offset + 40),
                feed_forward_angular_velocity_z = bitconverter.ToSingle(bytes, offset + 44),
                target_system = bytes[offset + 48],
                target_component = bytes[offset + 49],
            };
        }
        ...
        internal static MavlinkMessage Deserialize_AIS_VESSEL(byte[] bytes, int offset)
        {
            return new Msg_ais_vessel
            {
                MMSI = bitconverter.ToUInt32(bytes, offset + 0),
                lat = bitconverter.ToInt32(bytes, offset + 4),
                lon = bitconverter.ToInt32(bytes, offset + 8),
                COG = bitconverter.ToUInt16(bytes, offset + 12),
                heading = bitconverter.ToUInt16(bytes, offset + 14),
                velocity = bitconverter.ToUInt16(bytes, offset + 16),
                dimension_bow = bitconverter.ToUInt16(bytes, offset + 18),
                dimension_stern = bitconverter.ToUInt16(bytes, offset + 20),
                tslc = bitconverter.ToUInt16(bytes, offset + 22),
                flags = bitconverter.ToUInt16(bytes, offset + 24),
                turn_rate = bitconverter.ToInt8(bytes, offset + 26),
                navigational_status = bytes[offset + 27],
                type = bytes[offset + 28],
                dimension_port = bytes[offset + 29],
                dimension_starboard = bytes[offset + 30],
                callsign = ByteArrayUtil.ToChar(bytes, offset + 31, 7),
                name = ByteArrayUtil.ToChar(bytes, offset + 38, 20),
            };
        }
        ...
        internal static MavlinkMessage Deserialize_OBSTACLE_DISTANCE(byte[] bytes, int offset)
        {
            return new Msg_obstacle_distance
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                distances = ByteArrayUtil.ToUInt16(bytes, offset + 8, 72),
                min_distance = bitconverter.ToUInt16(bytes, offset + 152),
                max_distance = bitconverter.ToUInt16(bytes, offset + 154),
                sensor_type = bytes[offset + 156],
                increment = bytes[offset + 157],
                increment_f = bitconverter.ToSingle(bytes, offset + 158),
                angle_offset = bitconverter.ToSingle(bytes, offset + 162),
                frame = bytes[offset + 166],
            };
        }

        internal static MavlinkMessage Deserialize_ODOMETRY(byte[] bytes, int offset)
        {
            return new Msg_odometry
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                x = bitconverter.ToSingle(bytes, offset + 8),
                y = bitconverter.ToSingle(bytes, offset + 12),
                z = bitconverter.ToSingle(bytes, offset + 16),
                q = ByteArrayUtil.ToSingle(bytes, offset + 20, 4),
                vx = bitconverter.ToSingle(bytes, offset + 36),
                vy = bitconverter.ToSingle(bytes, offset + 40),
                vz = bitconverter.ToSingle(bytes, offset + 44),
                rollspeed = bitconverter.ToSingle(bytes, offset + 48),
                pitchspeed = bitconverter.ToSingle(bytes, offset + 52),
                yawspeed = bitconverter.ToSingle(bytes, offset + 56),
                pose_covariance = ByteArrayUtil.ToSingle(bytes, offset + 60, 21),
                velocity_covariance = ByteArrayUtil.ToSingle(bytes, offset + 144, 21),
                frame_id = bytes[offset + 228],
                child_frame_id = bytes[offset + 229],
                reset_counter = bytes[offset + 230],
                estimator_type = bytes[offset + 231],
            };
        }

        internal static MavlinkMessage Deserialize_TRAJECTORY_REPRESENTATION_WAYPOINTS(byte[] bytes, int offset)
        {
            return new Msg_trajectory_representation_waypoints
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                pos_x = ByteArrayUtil.ToSingle(bytes, offset + 8, 5),
                pos_y = ByteArrayUtil.ToSingle(bytes, offset + 28, 5),
                pos_z = ByteArrayUtil.ToSingle(bytes, offset + 48, 5),
                vel_x = ByteArrayUtil.ToSingle(bytes, offset + 68, 5),
                vel_y = ByteArrayUtil.ToSingle(bytes, offset + 88, 5),
                vel_z = ByteArrayUtil.ToSingle(bytes, offset + 108, 5),
                acc_x = ByteArrayUtil.ToSingle(bytes, offset + 128, 5),
                acc_y = ByteArrayUtil.ToSingle(bytes, offset + 148, 5),
                acc_z = ByteArrayUtil.ToSingle(bytes, offset + 168, 5),
                pos_yaw = ByteArrayUtil.ToSingle(bytes, offset + 188, 5),
                vel_yaw = ByteArrayUtil.ToSingle(bytes, offset + 208, 5),
                command = ByteArrayUtil.ToUInt16(bytes, offset + 228, 5),
                valid_points = bytes[offset + 238],
            };
        }

        internal static MavlinkMessage Deserialize_TRAJECTORY_REPRESENTATION_BEZIER(byte[] bytes, int offset)
        {
            return new Msg_trajectory_representation_bezier
            {
                ...
                pos_y = ByteArrayUtil.ToSingle(bytes, offset + 28, 5),
                pos_z = ByteArrayUtil.ToSingle(bytes, offset + 48, 5),
                delta = ByteArrayUtil.ToSingle(bytes, offset + 68, 5),
                pos_yaw = ByteArrayUtil.ToSingle(bytes, offset + 88, 5),
                valid_points = bytes[offset + 108],
            };
        }

        internal static MavlinkMessage Deserialize_CELLULAR_STATUS(byte[] bytes, int offset)
        {
            return new Msg_cellular_status
            {
                cid = bitconverter.ToUInt32(bytes, offset + 0),
                status = bitconverter.ToUInt16(bytes, offset + 4),
                mcc = bitconverter.ToUInt16(bytes, offset + 6),
                mnc = bitconverter.ToUInt16(bytes, offset + 8),
                lac = bitconverter.ToUInt16(bytes, offset + 10),
                type = bytes[offset + 12],
                quality = bytes[offset + 13],
            };
        }

        internal static MavlinkMessage Deserialize_ISBD_LINK_STATUS(byte[] bytes, int offset)
        {
            return new Msg_isbd_link_status
            {
                timestamp = bitconverter.ToUInt64(bytes, offset + 0),
                last_heartbeat = bitconverter.ToUInt64(bytes, offset + 8),
                failed_sessions = bitconverter.ToUInt16(bytes, offset + 16),
                successful_sessions = bitconverter.ToUInt16(bytes, offset + 18),
                signal_quality = bytes[offset + 20],
                ring_pending = bytes[offset + 21],
                tx_session_pending = bytes[offset + 22],
                rx_session_pending = bytes[offset + 23],
            };
        }

        internal static MavlinkMessage Deserialize_UTM_GLOBAL_POSITION(byte[] bytes, int offset)
        {
            return new Msg_utm_global_position
            {
                time = bitconverter.ToUInt64(bytes, offset + 0),
                lat = bitconverter.ToInt32(bytes, offset + 8),
                lon = bitconverter.ToInt32(bytes, offset + 12),
                alt = bitconverter.ToInt32(bytes, offset + 16),
                relative_alt = bitconverter.ToInt32(bytes, offset + 20),
                next_lat = bitconverter.ToInt32(bytes, offset + 24),
                next_lon = bitconverter.ToInt32(bytes, offset + 28),
                next_alt = bitconverter.ToInt32(bytes, offset + 32),
                vx = bitconverter.ToInt16(bytes, offset + 36),
                vy = bitconverter.ToInt16(bytes, offset + 38),
                vz = bitconverter.ToInt16(bytes, offset + 40),
                h_acc = bitconverter.ToUInt16(bytes, offset + 42),
                v_acc = bitconverter.ToUInt16(bytes, offset + 44),
                vel_acc = bitconverter.ToUInt16(bytes, offset + 46),
                update_rate = bitconverter.ToUInt16(bytes, offset + 48),
                uas_id = ByteArrayUtil.ToUInt8(bytes, offset + 50, 18),
                flight_state = bytes[offset + 68],
                flags = bytes[offset + 69],
            };
        }

        internal static MavlinkMessage Deserialize_DEBUG_FLOAT_ARRAY(byte[] bytes, int offset)
        {
            return new Msg_debug_float_array
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                array_id = bitconverter.ToUInt16(bytes, offset + 8),
                name = ByteArrayUtil.ToChar(bytes, offset + 10, 10),
                data = ByteArrayUtil.ToSingle(bytes, offset + 20, 58),
            };
        }

        internal static MavlinkMessage Deserialize_ORBIT_EXECUTION_STATUS(byte[] bytes, int offset)
        {
            return new Msg_orbit_execution_status
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                radius = bitconverter.ToSingle(bytes, offset + 8),
                x = bitconverter.ToInt32(bytes, offset + 12),
                y = bitconverter.ToInt32(bytes, offset + 16),
                z = bitconverter.ToSingle(bytes, offset + 20),
                frame = bytes[offset + 24],
            };
        }

        internal static MavlinkMessage Deserialize_SMART_BATTERY_INFO(byte[] bytes, int offset)
        {
            return new Msg_smart_battery_info
            {
                capacity_full_specification = bitconverter.ToInt32(bytes, offset + 0),
                capacity_full = bitconverter.ToInt32(bytes, offset + 4),
                serial_number = bitconverter.ToInt32(bytes, offset + 8),
                cycle_count = bitconverter.ToUInt16(bytes, offset + 12),
                weight = bitconverter.ToUInt16(bytes, offset + 14),
                discharge_minimum_voltage = bitconverter.ToUInt16(bytes, offset + 16),
                charging_minimum_voltage = bitconverter.ToUInt16(bytes, offset + 18),
                resting_minimum_voltage = bitconverter.ToUInt16(bytes, offset + 20),
                id = bytes[offset + 22],
                device_name = ByteArrayUtil.ToChar(bytes, offset + 23, 50),
            };
        }

        internal static MavlinkMessage Deserialize_SMART_BATTERY_STATUS(byte[] bytes, int offset)
        {
            return new Msg_smart_battery_status
            {
                fault_bitmask = bitconverter.ToInt32(bytes, offset + 0),
                time_remaining = bitconverter.ToInt32(bytes, offset + 4),
                id = bitconverter.ToUInt16(bytes, offset + 8),
                capacity_remaining = bitconverter.ToInt16(bytes, offset + 10),
                current = bitconverter.ToInt16(bytes, offset + 12),
                temperature = bitconverter.ToInt16(bytes, offset + 14),
                cell_offset = bitconverter.ToUInt16(bytes, offset + 16),
                voltages = ByteArrayUtil.ToUInt16(bytes, offset + 18, 16),
            };
        }

        internal static MavlinkMessage Deserialize_ACTUATOR_OUTPUT_STATUS(byte[] bytes, int offset)
        {
            return new Msg_actuator_output_status
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                active = bitconverter.ToUInt32(bytes, offset + 8),
                actuator = ByteArrayUtil.ToSingle(bytes, offset + 12, 32),
            };
        }

        internal static MavlinkMessage Deserialize_TIME_ESTIMATE_TO_TARGET(byte[] bytes, int offset)
        {
            return new Msg_time_estimate_to_target
            {
                safe_return = bitconverter.ToInt32(bytes, offset + 0),
                land = bitconverter.ToInt32(bytes, offset + 4),
                mission_next_item = bitconverter.ToInt32(bytes, offset + 8),
                mission_end = bitconverter.ToInt32(bytes, offset + 12),
                commanded_action = bitconverter.ToInt32(bytes, offset + 16),
            };
        }

        internal static MavlinkMessage Deserialize_TUNNEL(byte[] bytes, int offset)
        {
            return new Msg_tunnel
            {
                payload_type = bitconverter.ToUInt16(bytes, offset + 0),
                target_system = bytes[offset + 2],
                target_component = bytes[offset + 3],
                payload_length = bytes[offset + 4],
                payload = ByteArrayUtil.ToUInt8(bytes, offset + 5, 128),
            };
        }

        internal static MavlinkMessage Deserialize_ONBOARD_COMPUTER_STATUS(byte[] bytes, int offset)
        {
            return new Msg_onboard_computer_status
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                uptime = bitconverter.ToUInt32(bytes, offset + 8),
                ram_usage = bitconverter.ToUInt32(bytes, offset + 12),
                ram_total = bitconverter.ToUInt32(bytes, offset + 16),
                storage_type = ByteArrayUtil.ToUInt32(bytes, offset + 20, 4),
                storage_usage = ByteArrayUtil.ToUInt32(bytes, offset + 36, 4),
                storage_total = ByteArrayUtil.ToUInt32(bytes, offset + 52, 4),
                link_type = ByteArrayUtil.ToUInt32(bytes, offset + 68, 6),
                link_tx_rate = ByteArrayUtil.ToUInt32(bytes, offset + 92, 6),
                link_rx_rate = ByteArrayUtil.ToUInt32(bytes, offset + 116, 6),
                link_tx_max = ByteArrayUtil.ToUInt32(bytes, offset + 140, 6),
                link_rx_max = ByteArrayUtil.ToUInt32(bytes, offset + 164, 6),
                fan_speed = ByteArrayUtil.ToInt16(bytes, offset + 188, 4),
                type = bytes[offset + 196],
                cpu_cores = ByteArrayUtil.ToUInt8(bytes, offset + 197, 8),
                cpu_combined = ByteArrayUtil.ToUInt8(bytes, offset + 205, 10),
                gpu_cores = ByteArrayUtil.ToUInt8(bytes, offset + 215, 4),
                gpu_combined = ByteArrayUtil.ToUInt8(bytes, offset + 219, 10),
                temperature_board = bitconverter.ToInt8(bytes, offset + 229),
                temperature_core = ByteArrayUtil.ToInt8(bytes, offset + 230, 8),
            };
        }

        internal static MavlinkMessage Deserialize_COMPONENT_INFORMATION(byte[] bytes, int offset)
        {
            return new Msg_component_information
            {
                time_boot_ms = bitconverter.ToUInt32(bytes, offset + 0),
                firmware_version = bitconverter.ToUInt32(bytes, offset + 4),
                hardware_version = bitconverter.ToUInt32(bytes, offset + 8),
                capability_flags = bitconverter.ToUInt32(bytes, offset + 12),
                component_definition_version = bitconverter.ToUInt16(bytes, offset + 16),
                vendor_name = ByteArrayUtil.ToUInt8(bytes, offset + 18, 32),
                model_name = ByteArrayUtil.ToUInt8(bytes, offset + 50, 32),
                component_definition_uri = ByteArrayUtil.ToChar(bytes, offset + 82, 140),
            };
        }

        internal static MavlinkMessage Deserialize_PLAY_TUNE_V2(byte[] bytes, int offset)
        {
            return new Msg_play_tune_v2
            {
                format = bitconverter.ToUInt32(bytes, offset + 0),
                target_system = bytes[offset + 4],
                target_component = bytes[offset + 5],
                tune = ByteArrayUtil.ToChar(bytes, offset + 6, 248),
            };
        }

        internal static MavlinkMessage Deserialize_SUPPORTED_TUNES(byte[] bytes, int offset)
        {
            return new Msg_supported_tunes
            {
                format = bitconverter.ToUInt32(bytes, offset + 0),
                target_system = bytes[offset + 4],
                target_component = bytes[offset + 5],
        ...
        internal static MavlinkMessage Deserialize_WHEEL_DISTANCE(byte[] bytes, int offset)
        {
            return new Msg_wheel_distance
            {
                time_usec = bitconverter.ToUInt64(bytes, offset + 0),
                distance = ByteArrayUtil.ToDouble(bytes, offset + 8, 16),
                count = bytes[offset + 136],
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_BASIC_ID(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_basic_id
            {
                id_type = bytes[offset + 0],
                ua_type = bytes[offset + 1],
                uas_id = ByteArrayUtil.ToUInt8(bytes, offset + 2, 20),
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_LOCATION(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_location
            {
                latitude = bitconverter.ToInt32(bytes, offset + 0),
                longitude = bitconverter.ToInt32(bytes, offset + 4),
                altitude_barometric = bitconverter.ToSingle(bytes, offset + 8),
                altitude_geodetic = bitconverter.ToSingle(bytes, offset + 12),
                height = bitconverter.ToSingle(bytes, offset + 16),
                timestamp = bitconverter.ToSingle(bytes, offset + 20),
                direction = bitconverter.ToUInt16(bytes, offset + 24),
                speed_horizontal = bitconverter.ToUInt16(bytes, offset + 26),
                speed_vertical = bitconverter.ToInt16(bytes, offset + 28),
                status = bytes[offset + 30],
                height_reference = bytes[offset + 31],
                horizontal_accuracy = bytes[offset + 32],
                vertical_accuracy = bytes[offset + 33],
                barometer_accuracy = bytes[offset + 34],
                speed_accuracy = bytes[offset + 35],
                timestamp_accuracy = bytes[offset + 36],
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_AUTHENTICATION(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_authentication
            {
                timestamp = bitconverter.ToUInt32(bytes, offset + 0),
                authentication_type = bytes[offset + 4],
                data_page = bytes[offset + 5],
                page_count = bytes[offset + 6],
                length = bytes[offset + 7],
                authentication_data = ByteArrayUtil.ToUInt8(bytes, offset + 8, 23),
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_SELF_ID(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_self_id
            {
                description_type = bytes[offset + 0],
                description = ByteArrayUtil.ToChar(bytes, offset + 1, 23),
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_SYSTEM(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_system
            {
                operator_latitude = bitconverter.ToInt32(bytes, offset + 0),
                operator_longitude = bitconverter.ToInt32(bytes, offset + 4),
                area_ceiling = bitconverter.ToSingle(bytes, offset + 8),
                area_floor = bitconverter.ToSingle(bytes, offset + 12),
                area_count = bitconverter.ToUInt16(bytes, offset + 16),
                area_radius = bitconverter.ToUInt16(bytes, offset + 18),
                flags = bytes[offset + 20],
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_OPERATOR_ID(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_operator_id
            {
                operator_id_type = bytes[offset + 0],
                operator_id = ByteArrayUtil.ToChar(bytes, offset + 1, 20),
            };
        }

        internal static MavlinkMessage Deserialize_OPEN_DRONE_ID_MESSAGE_PACK(byte[] bytes, int offset)
        {
            return new Msg_open_drone_id_message_pack
            {
                single_message_size = bytes[offset + 0],
                msg_pack_size = bytes[offset + 1],
                messages = ByteArrayUtil.ToUInt8(bytes, offset + 2, 250),
            };
        }
        ...
        internal static int Serialize_LINK_NODE_STATUS(this Msg_link_node_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.timestamp, bytes, offset + 0);
            bitconverter.GetBytes(msg.tx_rate, bytes, offset + 8);
            bitconverter.GetBytes(msg.rx_rate, bytes, offset + 12);
            bitconverter.GetBytes(msg.messages_sent, bytes, offset + 16);
            bitconverter.GetBytes(msg.messages_received, bytes, offset + 20);
            bitconverter.GetBytes(msg.messages_lost, bytes, offset + 24);
            bitconverter.GetBytes(msg.rx_parse_err, bytes, offset + 28);
            bitconverter.GetBytes(msg.tx_overflows, bytes, offset + 30);
            bitconverter.GetBytes(msg.rx_overflows, bytes, offset + 32);
            bytes[offset + 34] = msg.tx_buf;
            bytes[offset + 35] = msg.rx_buf;
            offset += 36;
            return 8;
        }
        ...
        internal static int Serialize_GPS_RAW_INT(this Msg_gps_raw_int msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.yaw, bytes, offset + 50);
            offset += 52;
            return 24;
        }
        ...
        internal static int Serialize_SCALED_IMU(this Msg_scaled_imu msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.temperature, bytes, offset + 22);
            offset += 24;
            return 26;
        }
        ...
        internal static int Serialize_RAW_IMU(this Msg_raw_imu msg, byte[] bytes, ref int offset)
        {
            ...
            bytes[offset + 26] = msg.id;
            bitconverter.GetBytes(msg.temperature, bytes, offset + 27);
            offset += 29;
            return 27;
        }
        ...
        internal static int Serialize_ATTITUDE_QUATERNION(this Msg_attitude_quaternion msg, byte[] bytes, ref int offset)
        {
            ...
            ByteArrayUtil.ToByteArray(msg.repr_offset_q, bytes, offset + 32, 4);
            offset += 48;
            return 31;
        }
        ...
        internal static int Serialize_MISSION_CHANGED(this Msg_mission_changed msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.start_index, bytes, offset + 0);
            bitconverter.GetBytes(msg.end_index, bytes, offset + 2);
            bytes[offset + 4] = msg.origin_sysid;
            bytes[offset + 5] = msg.origin_compid;
            bytes[offset + 6] = msg.mission_type;
            offset += 7;
            return 52;
        }
        ...
        internal static int Serialize_RC_CHANNELS_OVERRIDE(this Msg_rc_channels_override msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.chan9_raw, bytes, offset + 18);
            bitconverter.GetBytes(msg.chan10_raw, bytes, offset + 20);
            bitconverter.GetBytes(msg.chan11_raw, bytes, offset + 22);
            bitconverter.GetBytes(msg.chan12_raw, bytes, offset + 24);
            bitconverter.GetBytes(msg.chan13_raw, bytes, offset + 26);
            bitconverter.GetBytes(msg.chan14_raw, bytes, offset + 28);
            bitconverter.GetBytes(msg.chan15_raw, bytes, offset + 30);
            bitconverter.GetBytes(msg.chan16_raw, bytes, offset + 32);
            bitconverter.GetBytes(msg.chan17_raw, bytes, offset + 34);
            bitconverter.GetBytes(msg.chan18_raw, bytes, offset + 36);
            offset += 38;
            return 70;
        }
        ...
        internal static int Serialize_COMMAND_ACK(this Msg_command_ack msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.result_param2, bytes, offset + 4);
        ...
        internal static int Serialize_GLOBAL_VISION_POSITION_ESTIMATE(this Msg_global_vision_position_estimate msg, byte[] bytes, ref int offset)
        {
            ...
            ByteArrayUtil.ToByteArray(msg.covariance, bytes, offset + 32, 21);
            bytes[offset + 116] = msg.reset_counter;
            offset += 117;
            return 101;
        }
        ...
        internal static int Serialize_VISION_SPEED_ESTIMATE(this Msg_vision_speed_estimate msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.y, bytes, offset + 12);
            bitconverter.GetBytes(msg.z, bytes, offset + 16);
            ByteArrayUtil.ToByteArray(msg.covariance, bytes, offset + 20, 9);
            bytes[offset + 56] = msg.reset_counter;
            offset += 57;
            return 103;
        }
        ...
        internal static int Serialize_GPS2_RAW(this Msg_gps2_raw msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.yaw, bytes, offset + 35);
            offset += 37;
            return 124;
        }
        ...
        internal static int Serialize_DISTANCE_SENSOR(this Msg_distance_sensor msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.horizontal_fov, bytes, offset + 14);
            bitconverter.GetBytes(msg.vertical_fov, bytes, offset + 18);
            ByteArrayUtil.ToByteArray(msg.quaternion, bytes, offset + 22, 4);
            offset += 38;
            return 132;
        }
        ...
        internal static int Serialize_ATT_POS_MOCAP(this Msg_att_pos_mocap msg, byte[] bytes, ref int offset)
        {
            ...
            ByteArrayUtil.ToByteArray(msg.covariance, bytes, offset + 36, 21);
            offset += 120;
            return 138;
        }
        ...
        internal static int Serialize_BATTERY_STATUS(this Msg_battery_status msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.time_remaining, bytes, offset + 36);
            bytes[offset + 40] = msg.charge_state;
            offset += 41;
            return 147;
        }
        ...
        internal static int Serialize_AUTOPILOT_VERSION(this Msg_autopilot_version msg, byte[] bytes, ref int offset)
        {
            ...
            ByteArrayUtil.ToByteArray(msg.uid2, bytes, offset + 60, 18);
            offset += 78;
            return 148;
        }
        ...
        internal static int Serialize_FENCE_STATUS(this Msg_fence_status msg, byte[] bytes, ref int offset)
        {
            ...
            bytes[offset + 8] = msg.breach_mitigation;
            offset += 9;
            return 162;
        }
        ...
        internal static int Serialize_GPS_INPUT(this Msg_gps_input msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.yaw, bytes, offset + 63);
            offset += 65;
            return 232;
        }
        ...
        internal static int Serialize_STATUSTEXT(this Msg_statustext msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.id, bytes, offset + 51);
            bytes[offset + 53] = msg.chunk_seq;
            offset += 54;
            return 253;
        }
        ...
        internal static int Serialize_PLAY_TUNE(this Msg_play_tune msg, byte[] bytes, ref int offset)
        {
            ...
            ByteArrayUtil.ToByteArray(msg.tune2, bytes, offset + 32, 200);
            offset += 232;
            return 258;
        }
        ...
        internal static int Serialize_CAMERA_SETTINGS(this Msg_camera_settings msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.zoomLevel, bytes, offset + 5);
            bitconverter.GetBytes(msg.focusLevel, bytes, offset + 9);
            offset += 13;
            return 260;
        }
        ...
        internal static int Serialize_MOUNT_ORIENTATION(this Msg_mount_orientation msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.pitch, bytes, offset + 8);
            bitconverter.GetBytes(msg.yaw, bytes, offset + 12);
            bitconverter.GetBytes(msg.yaw_absolute, bytes, offset + 16);
            offset += 20;
            return 265;
        }
        ...
        internal static int Serialize_VIDEO_STREAM_INFORMATION(this Msg_video_stream_information msg, byte[] bytes, ref int offset)
        {
            ...
            bitconverter.GetBytes(msg.flags, bytes, offset + 8);
            bitconverter.GetBytes(msg.resolution_h, bytes, offset + 10);
            bitconverter.GetBytes(msg.resolution_v, bytes, offset + 12);
            bitconverter.GetBytes(msg.rotation, bytes, offset + 14);
            bitconverter.GetBytes(msg.hfov, bytes, offset + 16);
            bytes[offset + 18] = msg.stream_id;
            bytes[offset + 19] = msg.count;
            bytes[offset + 20] = msg.type;
            ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 21, 32);
            ByteArrayUtil.ToByteArray(msg.uri, bytes, offset + 53, 160);
            offset += 213;
            return 269;
        }

        internal static int Serialize_VIDEO_STREAM_STATUS(this Msg_video_stream_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.framerate, bytes, offset + 0);
            bitconverter.GetBytes(msg.bitrate, bytes, offset + 4);
            bitconverter.GetBytes(msg.flags, bytes, offset + 8);
        ...
        internal static int Serialize_GIMBAL_MANAGER_INFORMATION(this Msg_gimbal_manager_information msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
            bitconverter.GetBytes(msg.cap_flags, bytes, offset + 4);
            bitconverter.GetBytes(msg.tilt_max, bytes, offset + 8);
            bitconverter.GetBytes(msg.tilt_min, bytes, offset + 12);
            bitconverter.GetBytes(msg.tilt_rate_max, bytes, offset + 16);
            bitconverter.GetBytes(msg.pan_max, bytes, offset + 20);
            bitconverter.GetBytes(msg.pan_min, bytes, offset + 24);
            bitconverter.GetBytes(msg.pan_rate_max, bytes, offset + 28);
            bytes[offset + 32] = msg.gimbal_component;
            offset += 33;
            return 280;
        }

        internal static int Serialize_GIMBAL_MANAGER_STATUS(this Msg_gimbal_manager_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
            bitconverter.GetBytes(msg.flags, bytes, offset + 4);
            offset += 8;
        ...
        internal static int Serialize_GIMBAL_MANAGER_SET_ATTITUDE(this Msg_gimbal_manager_set_attitude msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.flags, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 4, 4);
            bitconverter.GetBytes(msg.angular_velocity_x, bytes, offset + 20);
            bitconverter.GetBytes(msg.angular_velocity_y, bytes, offset + 24);
            bitconverter.GetBytes(msg.angular_velocity_z, bytes, offset + 28);
            bytes[offset + 32] = msg.target_system;
            bytes[offset + 33] = msg.target_component;
            offset += 34;
            return 282;
        ...
        internal static int Serialize_GIMBAL_DEVICE_INFORMATION(this Msg_gimbal_device_information msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
            bitconverter.GetBytes(msg.firmware_version, bytes, offset + 4);
            bitconverter.GetBytes(msg.tilt_max, bytes, offset + 8);
            ...
            bitconverter.GetBytes(msg.pan_min, bytes, offset + 24);
            bitconverter.GetBytes(msg.pan_rate_max, bytes, offset + 28);
            bitconverter.GetBytes(msg.cap_flags, bytes, offset + 32);
            ByteArrayUtil.ToByteArray(msg.vendor_name, bytes, offset + 34, 32);
            ByteArrayUtil.ToByteArray(msg.model_name, bytes, offset + 66, 32);
            offset += 98;
            return 283;
        }

        internal static int Serialize_GIMBAL_DEVICE_SET_ATTITUDE(this Msg_gimbal_device_set_attitude msg, byte[] bytes, ref int offset)
        {
            ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 0, 4);
            bitconverter.GetBytes(msg.angular_velocity_x, bytes, offset + 16);
            bitconverter.GetBytes(msg.angular_velocity_y, bytes, offset + 20);
            bitconverter.GetBytes(msg.angular_velocity_z, bytes, offset + 24);
            bitconverter.GetBytes(msg.flags, bytes, offset + 28);
            bytes[offset + 30] = msg.target_system;
            bytes[offset + 31] = msg.target_component;
            offset += 32;
            return 284;
        ...
        internal static int Serialize_GIMBAL_DEVICE_ATTITUDE_STATUS(this Msg_gimbal_device_attitude_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 4, 4);
            bitconverter.GetBytes(msg.angular_velocity_x, bytes, offset + 20);
            bitconverter.GetBytes(msg.angular_velocity_y, bytes, offset + 24);
            bitconverter.GetBytes(msg.angular_velocity_z, bytes, offset + 28);
            bitconverter.GetBytes(msg.failure_flags, bytes, offset + 32);
            bitconverter.GetBytes(msg.flags, bytes, offset + 36);
            offset += 38;
            return 285;
        }

        internal static int Serialize_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE(this Msg_autopilot_state_for_gimbal_device msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_boot_us, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 8, 4);
            bitconverter.GetBytes(msg.q_estimated_delay_us, bytes, offset + 24);
            ...
            bitconverter.GetBytes(msg.v_estimated_delay_us, bytes, offset + 40);
            bitconverter.GetBytes(msg.feed_forward_angular_velocity_z, bytes, offset + 44);
            bytes[offset + 48] = msg.target_system;
            bytes[offset + 49] = msg.target_component;
            offset += 50;
            return 286;
        }
        ...
        internal static int Serialize_AIS_VESSEL(this Msg_ais_vessel msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.MMSI, bytes, offset + 0);
            bitconverter.GetBytes(msg.lat, bytes, offset + 4);
            bitconverter.GetBytes(msg.lon, bytes, offset + 8);
            bitconverter.GetBytes(msg.COG, bytes, offset + 12);
            bitconverter.GetBytes(msg.heading, bytes, offset + 14);
            bitconverter.GetBytes(msg.velocity, bytes, offset + 16);
            bitconverter.GetBytes(msg.dimension_bow, bytes, offset + 18);
            bitconverter.GetBytes(msg.dimension_stern, bytes, offset + 20);
            bitconverter.GetBytes(msg.tslc, bytes, offset + 22);
            bitconverter.GetBytes(msg.flags, bytes, offset + 24);
            bytes[offset + 26] = unchecked((byte)msg.turn_rate);
            bytes[offset + 27] = msg.navigational_status;
            bytes[offset + 28] = msg.type;
            bytes[offset + 29] = msg.dimension_port;
            bytes[offset + 30] = msg.dimension_starboard;
            ByteArrayUtil.ToByteArray(msg.callsign, bytes, offset + 31, 7);
            ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 38, 20);
            offset += 58;
            return 301;
        }
        ...
        internal static int Serialize_OBSTACLE_DISTANCE(this Msg_obstacle_distance msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.distances, bytes, offset + 8, 72);
            bitconverter.GetBytes(msg.min_distance, bytes, offset + 152);
            bitconverter.GetBytes(msg.max_distance, bytes, offset + 154);
            bytes[offset + 156] = msg.sensor_type;
            bytes[offset + 157] = msg.increment;
            bitconverter.GetBytes(msg.increment_f, bytes, offset + 158);
            bitconverter.GetBytes(msg.angle_offset, bytes, offset + 162);
            bytes[offset + 166] = msg.frame;
            offset += 167;
            return 330;
        }

        internal static int Serialize_ODOMETRY(this Msg_odometry msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            bitconverter.GetBytes(msg.x, bytes, offset + 8);
            bitconverter.GetBytes(msg.y, bytes, offset + 12);
            bitconverter.GetBytes(msg.z, bytes, offset + 16);
            ByteArrayUtil.ToByteArray(msg.q, bytes, offset + 20, 4);
            bitconverter.GetBytes(msg.vx, bytes, offset + 36);
            bitconverter.GetBytes(msg.vy, bytes, offset + 40);
            bitconverter.GetBytes(msg.vz, bytes, offset + 44);
            bitconverter.GetBytes(msg.rollspeed, bytes, offset + 48);
            bitconverter.GetBytes(msg.pitchspeed, bytes, offset + 52);
            bitconverter.GetBytes(msg.yawspeed, bytes, offset + 56);
            ByteArrayUtil.ToByteArray(msg.pose_covariance, bytes, offset + 60, 21);
            ByteArrayUtil.ToByteArray(msg.velocity_covariance, bytes, offset + 144, 21);
            bytes[offset + 228] = msg.frame_id;
            bytes[offset + 229] = msg.child_frame_id;
            bytes[offset + 230] = msg.reset_counter;
            bytes[offset + 231] = msg.estimator_type;
            offset += 232;
            return 331;
        }

        internal static int Serialize_TRAJECTORY_REPRESENTATION_WAYPOINTS(this Msg_trajectory_representation_waypoints msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.pos_x, bytes, offset + 8, 5);
            ByteArrayUtil.ToByteArray(msg.pos_y, bytes, offset + 28, 5);
            ByteArrayUtil.ToByteArray(msg.pos_z, bytes, offset + 48, 5);
            ByteArrayUtil.ToByteArray(msg.vel_x, bytes, offset + 68, 5);
            ByteArrayUtil.ToByteArray(msg.vel_y, bytes, offset + 88, 5);
            ByteArrayUtil.ToByteArray(msg.vel_z, bytes, offset + 108, 5);
            ByteArrayUtil.ToByteArray(msg.acc_x, bytes, offset + 128, 5);
            ByteArrayUtil.ToByteArray(msg.acc_y, bytes, offset + 148, 5);
            ByteArrayUtil.ToByteArray(msg.acc_z, bytes, offset + 168, 5);
            ByteArrayUtil.ToByteArray(msg.pos_yaw, bytes, offset + 188, 5);
            ByteArrayUtil.ToByteArray(msg.vel_yaw, bytes, offset + 208, 5);
            ByteArrayUtil.ToByteArray(msg.command, bytes, offset + 228, 5);
            bytes[offset + 238] = msg.valid_points;
            offset += 239;
            return 332;
        }

        internal static int Serialize_TRAJECTORY_REPRESENTATION_BEZIER(this Msg_trajectory_representation_bezier msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.pos_x, bytes, offset + 8, 5);
            ByteArrayUtil.ToByteArray(msg.pos_y, bytes, offset + 28, 5);
            ByteArrayUtil.ToByteArray(msg.pos_z, bytes, offset + 48, 5);
            ByteArrayUtil.ToByteArray(msg.delta, bytes, offset + 68, 5);
            ByteArrayUtil.ToByteArray(msg.pos_yaw, bytes, offset + 88, 5);
            bytes[offset + 108] = msg.valid_points;
            offset += 109;
            return 333;
        }

        internal static int Serialize_CELLULAR_STATUS(this Msg_cellular_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.cid, bytes, offset + 0);
            bitconverter.GetBytes(msg.status, bytes, offset + 4);
            bitconverter.GetBytes(msg.mcc, bytes, offset + 6);
            bitconverter.GetBytes(msg.mnc, bytes, offset + 8);
            bitconverter.GetBytes(msg.lac, bytes, offset + 10);
            bytes[offset + 12] = msg.type;
            bytes[offset + 13] = msg.quality;
            offset += 14;
            return 334;
        }

        internal static int Serialize_ISBD_LINK_STATUS(this Msg_isbd_link_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.timestamp, bytes, offset + 0);
            bitconverter.GetBytes(msg.last_heartbeat, bytes, offset + 8);
            bitconverter.GetBytes(msg.failed_sessions, bytes, offset + 16);
            bitconverter.GetBytes(msg.successful_sessions, bytes, offset + 18);
            bytes[offset + 20] = msg.signal_quality;
            bytes[offset + 21] = msg.ring_pending;
            bytes[offset + 22] = msg.tx_session_pending;
            bytes[offset + 23] = msg.rx_session_pending;
            offset += 24;
            return 335;
        }

        internal static int Serialize_UTM_GLOBAL_POSITION(this Msg_utm_global_position msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time, bytes, offset + 0);
            bitconverter.GetBytes(msg.lat, bytes, offset + 8);
            bitconverter.GetBytes(msg.lon, bytes, offset + 12);
            bitconverter.GetBytes(msg.alt, bytes, offset + 16);
            bitconverter.GetBytes(msg.relative_alt, bytes, offset + 20);
            bitconverter.GetBytes(msg.next_lat, bytes, offset + 24);
            bitconverter.GetBytes(msg.next_lon, bytes, offset + 28);
            bitconverter.GetBytes(msg.next_alt, bytes, offset + 32);
            bitconverter.GetBytes(msg.vx, bytes, offset + 36);
            bitconverter.GetBytes(msg.vy, bytes, offset + 38);
            bitconverter.GetBytes(msg.vz, bytes, offset + 40);
            bitconverter.GetBytes(msg.h_acc, bytes, offset + 42);
            bitconverter.GetBytes(msg.v_acc, bytes, offset + 44);
            bitconverter.GetBytes(msg.vel_acc, bytes, offset + 46);
            bitconverter.GetBytes(msg.update_rate, bytes, offset + 48);
            ByteArrayUtil.ToByteArray(msg.uas_id, bytes, offset + 50, 18);
            bytes[offset + 68] = msg.flight_state;
            bytes[offset + 69] = msg.flags;
            offset += 70;
            return 340;
        }

        internal static int Serialize_DEBUG_FLOAT_ARRAY(this Msg_debug_float_array msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            bitconverter.GetBytes(msg.array_id, bytes, offset + 8);
            ByteArrayUtil.ToByteArray(msg.name, bytes, offset + 10, 10);
            ByteArrayUtil.ToByteArray(msg.data, bytes, offset + 20, 58);
            offset += 252;
            return 350;
        }

        internal static int Serialize_ORBIT_EXECUTION_STATUS(this Msg_orbit_execution_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            bitconverter.GetBytes(msg.radius, bytes, offset + 8);
            bitconverter.GetBytes(msg.x, bytes, offset + 12);
            bitconverter.GetBytes(msg.y, bytes, offset + 16);
            bitconverter.GetBytes(msg.z, bytes, offset + 20);
            bytes[offset + 24] = msg.frame;
        ...
        internal static int Serialize_SMART_BATTERY_INFO(this Msg_smart_battery_info msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.capacity_full_specification, bytes, offset + 0);
            bitconverter.GetBytes(msg.capacity_full, bytes, offset + 4);
            bitconverter.GetBytes(msg.serial_number, bytes, offset + 8);
            bitconverter.GetBytes(msg.cycle_count, bytes, offset + 12);
            bitconverter.GetBytes(msg.weight, bytes, offset + 14);
            bitconverter.GetBytes(msg.discharge_minimum_voltage, bytes, offset + 16);
            bitconverter.GetBytes(msg.charging_minimum_voltage, bytes, offset + 18);
            bitconverter.GetBytes(msg.resting_minimum_voltage, bytes, offset + 20);
            bytes[offset + 22] = msg.id;
            ByteArrayUtil.ToByteArray(msg.device_name, bytes, offset + 23, 50);
            offset += 73;
            return 370;
        }

        internal static int Serialize_SMART_BATTERY_STATUS(this Msg_smart_battery_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.fault_bitmask, bytes, offset + 0);
            bitconverter.GetBytes(msg.time_remaining, bytes, offset + 4);
            bitconverter.GetBytes(msg.id, bytes, offset + 8);
            bitconverter.GetBytes(msg.capacity_remaining, bytes, offset + 10);
            bitconverter.GetBytes(msg.current, bytes, offset + 12);
            bitconverter.GetBytes(msg.temperature, bytes, offset + 14);
            bitconverter.GetBytes(msg.cell_offset, bytes, offset + 16);
            ByteArrayUtil.ToByteArray(msg.voltages, bytes, offset + 18, 16);
            offset += 50;
            return 371;
        }

        internal static int Serialize_ACTUATOR_OUTPUT_STATUS(this Msg_actuator_output_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            bitconverter.GetBytes(msg.active, bytes, offset + 8);
            ByteArrayUtil.ToByteArray(msg.actuator, bytes, offset + 12, 32);
            offset += 140;
            return 375;
        }

        internal static int Serialize_TIME_ESTIMATE_TO_TARGET(this Msg_time_estimate_to_target msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.safe_return, bytes, offset + 0);
            bitconverter.GetBytes(msg.land, bytes, offset + 4);
            bitconverter.GetBytes(msg.mission_next_item, bytes, offset + 8);
            bitconverter.GetBytes(msg.mission_end, bytes, offset + 12);
            bitconverter.GetBytes(msg.commanded_action, bytes, offset + 16);
            offset += 20;
            return 380;
        }

        internal static int Serialize_TUNNEL(this Msg_tunnel msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.payload_type, bytes, offset + 0);
            bytes[offset + 2] = msg.target_system;
            bytes[offset + 3] = msg.target_component;
            bytes[offset + 4] = msg.payload_length;
            ByteArrayUtil.ToByteArray(msg.payload, bytes, offset + 5, 128);
            offset += 133;
            return 385;
        }

        internal static int Serialize_ONBOARD_COMPUTER_STATUS(this Msg_onboard_computer_status msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            bitconverter.GetBytes(msg.uptime, bytes, offset + 8);
            bitconverter.GetBytes(msg.ram_usage, bytes, offset + 12);
            bitconverter.GetBytes(msg.ram_total, bytes, offset + 16);
            ByteArrayUtil.ToByteArray(msg.storage_type, bytes, offset + 20, 4);
            ByteArrayUtil.ToByteArray(msg.storage_usage, bytes, offset + 36, 4);
            ByteArrayUtil.ToByteArray(msg.storage_total, bytes, offset + 52, 4);
            ByteArrayUtil.ToByteArray(msg.link_type, bytes, offset + 68, 6);
            ByteArrayUtil.ToByteArray(msg.link_tx_rate, bytes, offset + 92, 6);
            ByteArrayUtil.ToByteArray(msg.link_rx_rate, bytes, offset + 116, 6);
            ByteArrayUtil.ToByteArray(msg.link_tx_max, bytes, offset + 140, 6);
            ByteArrayUtil.ToByteArray(msg.link_rx_max, bytes, offset + 164, 6);
            ByteArrayUtil.ToByteArray(msg.fan_speed, bytes, offset + 188, 4);
            bytes[offset + 196] = msg.type;
            ByteArrayUtil.ToByteArray(msg.cpu_cores, bytes, offset + 197, 8);
            ByteArrayUtil.ToByteArray(msg.cpu_combined, bytes, offset + 205, 10);
            ByteArrayUtil.ToByteArray(msg.gpu_cores, bytes, offset + 215, 4);
            ByteArrayUtil.ToByteArray(msg.gpu_combined, bytes, offset + 219, 10);
            bytes[offset + 229] = unchecked((byte)msg.temperature_board);
            ByteArrayUtil.ToByteArray(msg.temperature_core, bytes, offset + 230, 8);
            offset += 238;
            return 390;
        }

        internal static int Serialize_COMPONENT_INFORMATION(this Msg_component_information msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_boot_ms, bytes, offset + 0);
            bitconverter.GetBytes(msg.firmware_version, bytes, offset + 4);
            bitconverter.GetBytes(msg.hardware_version, bytes, offset + 8);
            bitconverter.GetBytes(msg.capability_flags, bytes, offset + 12);
            bitconverter.GetBytes(msg.component_definition_version, bytes, offset + 16);
            ByteArrayUtil.ToByteArray(msg.vendor_name, bytes, offset + 18, 32);
            ByteArrayUtil.ToByteArray(msg.model_name, bytes, offset + 50, 32);
            ByteArrayUtil.ToByteArray(msg.component_definition_uri, bytes, offset + 82, 140);
            offset += 222;
            return 395;
        }

        internal static int Serialize_PLAY_TUNE_V2(this Msg_play_tune_v2 msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.format, bytes, offset + 0);
            bytes[offset + 4] = msg.target_system;
            bytes[offset + 5] = msg.target_component;
            ByteArrayUtil.ToByteArray(msg.tune, bytes, offset + 6, 248);
            offset += 254;
            return 400;
        }

        internal static int Serialize_SUPPORTED_TUNES(this Msg_supported_tunes msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.format, bytes, offset + 0);
            bytes[offset + 4] = msg.target_system;
            bytes[offset + 5] = msg.target_component;
        ...
        internal static int Serialize_WHEEL_DISTANCE(this Msg_wheel_distance msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.time_usec, bytes, offset + 0);
            ByteArrayUtil.ToByteArray(msg.distance, bytes, offset + 8, 16);
            bytes[offset + 136] = msg.count;
            offset += 137;
            return 9000;
        }

        internal static int Serialize_OPEN_DRONE_ID_BASIC_ID(this Msg_open_drone_id_basic_id msg, byte[] bytes, ref int offset)
        {
            bytes[offset + 0] = msg.id_type;
            bytes[offset + 1] = msg.ua_type;
            ByteArrayUtil.ToByteArray(msg.uas_id, bytes, offset + 2, 20);
            offset += 22;
            return 12900;
        }

        internal static int Serialize_OPEN_DRONE_ID_LOCATION(this Msg_open_drone_id_location msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.latitude, bytes, offset + 0);
            bitconverter.GetBytes(msg.longitude, bytes, offset + 4);
            bitconverter.GetBytes(msg.altitude_barometric, bytes, offset + 8);
            bitconverter.GetBytes(msg.altitude_geodetic, bytes, offset + 12);
            bitconverter.GetBytes(msg.height, bytes, offset + 16);
            bitconverter.GetBytes(msg.timestamp, bytes, offset + 20);
            bitconverter.GetBytes(msg.direction, bytes, offset + 24);
            bitconverter.GetBytes(msg.speed_horizontal, bytes, offset + 26);
            bitconverter.GetBytes(msg.speed_vertical, bytes, offset + 28);
            bytes[offset + 30] = msg.status;
            bytes[offset + 31] = msg.height_reference;
            bytes[offset + 32] = msg.horizontal_accuracy;
            bytes[offset + 33] = msg.vertical_accuracy;
            bytes[offset + 34] = msg.barometer_accuracy;
            bytes[offset + 35] = msg.speed_accuracy;
            bytes[offset + 36] = msg.timestamp_accuracy;
            offset += 37;
            return 12901;
        }

        internal static int Serialize_OPEN_DRONE_ID_AUTHENTICATION(this Msg_open_drone_id_authentication msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.timestamp, bytes, offset + 0);
            bytes[offset + 4] = msg.authentication_type;
            bytes[offset + 5] = msg.data_page;
            bytes[offset + 6] = msg.page_count;
            bytes[offset + 7] = msg.length;
            ByteArrayUtil.ToByteArray(msg.authentication_data, bytes, offset + 8, 23);
            offset += 31;
            return 12902;
        }

        internal static int Serialize_OPEN_DRONE_ID_SELF_ID(this Msg_open_drone_id_self_id msg, byte[] bytes, ref int offset)
        {
            bytes[offset + 0] = msg.description_type;
            ByteArrayUtil.ToByteArray(msg.description, bytes, offset + 1, 23);
            offset += 24;
            return 12903;
        }

        internal static int Serialize_OPEN_DRONE_ID_SYSTEM(this Msg_open_drone_id_system msg, byte[] bytes, ref int offset)
        {
            bitconverter.GetBytes(msg.operator_latitude, bytes, offset + 0);
            bitconverter.GetBytes(msg.operator_longitude, bytes, offset + 4);
            bitconverter.GetBytes(msg.area_ceiling, bytes, offset + 8);
            bitconverter.GetBytes(msg.area_floor, bytes, offset + 12);
            bitconverter.GetBytes(msg.area_count, bytes, offset + 16);
            bitconverter.GetBytes(msg.area_radius, bytes, offset + 18);
            bytes[offset + 20] = msg.flags;
            offset += 21;
            return 12904;
        }

        internal static int Serialize_OPEN_DRONE_ID_OPERATOR_ID(this Msg_open_drone_id_operator_id msg, byte[] bytes, ref int offset)
        {
            bytes[offset + 0] = msg.operator_id_type;
            ByteArrayUtil.ToByteArray(msg.operator_id, bytes, offset + 1, 20);
            offset += 21;
            return 12905;
        }

        internal static int Serialize_OPEN_DRONE_ID_MESSAGE_PACK(this Msg_open_drone_id_message_pack msg, byte[] bytes, ref int offset)
        {
            bytes[offset + 0] = msg.single_message_size;
            bytes[offset + 1] = msg.msg_pack_size;
            ByteArrayUtil.ToByteArray(msg.messages, bytes, offset + 2, 250);
            offset += 252;
            return 12915;
        }
    }
