...
namespace RaspberryPiClient.CustomControls
{
    public partial class InstrumentControl : Control
    {
        ...
        internal void DisplayRoundMark(PaintEventArgs pe, Image imgMark, InstrumentControlMarksDefinition insControlMarksDefinition, Point ptImg, int radiusPx, bool displayText, float scaleFactor)
        {
            Double alphaRot;
            int textBoxLength;
