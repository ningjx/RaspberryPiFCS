...
namespace MavLink
{
	...
	/// ContrlMode
	/// </summary>
	public class Msg_contrlmode : MavlinkMessage
    {
		public byte contrlmode;

        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_ContrlMode(this, bytes, ref offset);
            }        
	}
	...
	public class Msg_log : MavlinkMessage
    {
		...
		public UInt32 time_boot_ms;
		public byte logtype;
		public byte[] logtext; // Array size 50
